      ...
      <div className="bg-gradient-to-r from-primary/10 to-primary/5 border-b">
        <div className="max-w-[1500px] mx-auto px-4 py-8">
          ...
          <p className="text-gray-600 max-w-3xl mt-2">
            ...
            ShopSphere. By accessing or using our platform, you agree to be
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                By accessing or using ShopSphere ("Platform," "Service," "we,"
              ...
              <p>
                These terms apply to all users, including customers, sellers,
                riders, and visitors. Additional terms may apply to specific
                services, which will be presented to you at the time of use.
              </p>
              <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <span className="text-primary">2.</span> Eligibility and Account
              Registration
            </h2>
            <div className="space-y-6 text-gray-700">
              <div>
                ...
                <p>
                  ...
                  registering an account, you represent and warrant that you are
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Not create multiple accounts or transfer your account to
                    others
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="mb-3">
                  ShopSphere offers three types of accounts:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <strong>Customer Account:</strong> For purchasing products
                  </li>
                  <li>
                    <strong>Seller Account:</strong> For listing and selling
                    products (requires verification and approval)
                  </li>
                  <li>
                    <strong>Rider Account:</strong> For providing delivery
                    services (requires verification and approval)
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  any other reason we deem necessary to protect our Platform and
                  users.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6 text-gray-700">
              <div>
                ...
                <p>
                  ...
                  products. All orders are subject to acceptance by the seller.
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Prices are set by individual sellers and may change without
                    notice
                  </li>
                  <li>
                    You agree to pay the total amount including product price,
                    delivery charges, and applicable taxes
                  </li>
                  <li>Payment must be made through approved payment methods</li>
                  <li>
                    We are not responsible for additional charges from payment
                    processors or banks
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p>
                  You may cancel orders before they are shipped, subject to the
                  seller's cancellation policy. Refunds will be processed
              ...
              <div>
                ...
                <p className="mb-3">
                  Return and refund policies are determined by individual
                  sellers, but must meet our minimum standards:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    Defective or damaged products must be accepted for return
                  </li>
              ...
              <div>
                ...
                <p>
                  You may leave reviews for purchased products. Reviews must be
                  honest, relevant, and not contain offensive, defamatory, or
                  promotional content. We reserve the right to remove reviews
            ...
            <div className="space-y-6 text-gray-700">
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Process orders promptly and ship within promised timeframes
                  </li>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Stolen goods or products violating intellectual property
                    rights
                  </li>
                  <li>
                    Adult content, tobacco, or alcohol (without proper
                    licensing)
                  </li>
              ...
              <div>
                ...
                <p>
                  ShopSphere charges a commission on each sale. The commission
                  structure will be provided during seller registration. Fees
                  are subject to change with 30 days notice. Payment to sellers
                  will be processed according to our payment schedule, typically
                  within 7-14 days after delivery confirmation.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-3">
                  Failure to meet these standards may result in account
              ...
              <div>
                ...
                <p>
                  Sellers are responsible for all applicable taxes, including
                  VAT, income tax, and business taxes. We may collect and remit
            ...
            <div className="space-y-6 text-gray-700">
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Maintain professional conduct with customers and sellers
                  </li>
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-800 mb-3">
                  5.3 Payment and Earnings
                </h3>
                <p>
                  Riders earn fees per delivery based on distance, package size,
                  and other factors. Payment will be processed weekly or
                  bi-weekly. Tips from customers belong to the rider.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  Riders are independent contractors, not employees of
                  ShopSphere. You are responsible for your own taxes, insurance,
                  and expenses. ShopSphere does not provide employment benefits.
                </p>
              </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6 text-gray-700">
              <div>
                ...
                <p>
                  All content on ShopSphere, including text, graphics, logos,
                  images, software, and design, is owned by ShopSphere or our
                  licensors and protected by intellectual property laws. You may
              ...
              <div>
                ...
                <p>
                  By posting content (product listings, reviews, photos, etc.),
                  you grant ShopSphere a worldwide, non-exclusive, royalty-free
                  license to use, reproduce, modify, and display that content.
                  You retain ownership of your content but are responsible for
              ...
              <div>
                ...
                <p>
                  ShopSphere, our logo, and other marks are trademarks of
                  ShopSphere. You may not use our trademarks without prior
                  written consent.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  <a
                    href="mailto:legal@shopsphere.com"
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <span className="text-primary">8.</span> Disclaimers and
            ...
            <div className="space-y-6 text-gray-700">
              <div>
                ...
                <p>
                  ShopSphere is provided "as is" and "as available" without
                  warranties of any kind, express or implied. We do not warrant
                  that the Platform will be uninterrupted, error-free, or
                  secure.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ShopSphere is a marketplace platform connecting buyers,
                  sellers, and riders. We are not a party to transactions
                  between users and are not responsible for the quality, safety,
                  legality, or accuracy of products listed. Disputes should be
              ...
              <div>
                ...
                <p>
                  To the fullest extent permitted by law, ShopSphere and its
                ...
                <p className="mt-3">
                  ...
                  terms or your use of the Platform shall not exceed the amount
                  you paid to us in the 12 months preceding the claim, or BDT
              ...
              <div>
                ...
                <p>
                  ...
                  monitor or mediate disputes between users.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                You agree to indemnify, defend, and hold harmless ShopSphere and
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6 text-gray-700">
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <strong>Step 1:</strong> Contact our customer support to
                    attempt informal resolution
                  </li>
                  <li>
                    <strong>Step 2:</strong> If unresolved, engage in good-faith
                    mediation
                  </li>
                  <li>
                    <strong>Step 3:</strong> If mediation fails, disputes shall
                    be resolved through arbitration in Dhaka, Bangladesh
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p>
                  For any disputes not subject to arbitration, you agree to
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <span className="text-primary">11.</span> Privacy and Data
              Protection
            </h2>
            <div className="space-y-4 text-gray-700">
              <p>
                Your use of ShopSphere is subject to our Privacy Policy, which
                describes how we collect, use, and protect your personal
                information. By using our Platform, you consent to our data
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <p className="mt-4">
                Your continued use of the Platform after modifications become
                effective constitutes acceptance of the updated terms. If you do
                not agree to the modified terms, you must stop using the
                Platform.
              </p>
            </div>
          </section>
            ...
            <div className="space-y-6 text-gray-700">
              <div>
                ...
                <p>
                  ...
                  customer support or through your account settings. Upon
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Continuing your access poses risks to other users or the
                    Platform
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  immediately cease. We may delete your data and content, though
            ...
            <div className="space-y-6 text-gray-700">
              <div>
                ...
                <p>
                  ...
                  and any additional terms you agree to, constitute the entire
                  agreement between you and ShopSphere.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  without our prior written consent. We may assign our rights
              ...
              <div>
                ...
                <p>
                  ...
                  natural disasters, war, terrorism, labor disputes, or
                  government actions.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  These Terms and Conditions are written in English. Any
                  translations are provided for convenience only. In case of
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <div className="bg-base-200 p-6 rounded-lg mt-4">
                ...
                <div className="space-y-2">
                  ...
                  <p>
                    <strong>Address:</strong> House #123, Road #456, Dhaka 1212,
                    Bangladesh
                  </p>
                </div>
              </div>
          ...
          <section className="mb-12 bg-primary/5 border-l-4 border-primary p-6 rounded">
            ...
            <p className="text-gray-700">
              By using ShopSphere, you acknowledge that you have read,
