    ...
    <div className="min-h-screen bg-base-100">
      ...
      <div className="bg-gradient-to-r from-primary/10 to-primary/5 border-b">
        <div className="max-w-[1500px] mx-auto px-4 py-8">
          ...
          <p className="text-gray-600 max-w-3xl mt-2">
            ...
            ShopSphere collects, uses, discloses, and safeguards your
            information.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-[1500px] mx-auto px-4 py-12">
        <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-6 text-gray-700">
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Payment information (credit/debit card details, mobile
                    banking information)
                  </li>
                  <li>
                    Profile information (profile picture, preferences, wishlist)
                  </li>
                  <li>
                    Business information for sellers (business name, tax ID,
                    bank account details)
                  </li>
                  <li>
                    Delivery information for riders (vehicle details, driving
                    license)
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p>
                  We may receive information from payment processors, delivery
                  partners, social media platforms (if you connect your
                  account), and fraud prevention services.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  ...
                  facilitate payments, and coordinate deliveries
                </li>
                <li>
                  <strong>Account Management:</strong> To create and manage your
                  account, verify identity, and provide customer support
                </li>
                <li>
                ...
                <li>
                  ...
                  shipping updates, promotional offers, and important notices
                </li>
                <li>
                ...
                <li>
                  <strong>Personalization:</strong> To provide personalized
                  recommendations and content based on your preferences
                </li>
                <li>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <span className="text-primary">3.</span> Information Sharing and
              Disclosure
            </h2>
            <div className="space-y-6 text-gray-700">
              <div>
                ...
                <p>
                  We may share your information with third parties when you give
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-800 mb-3">
                  3.3 Sellers and Buyers
                </h3>
                <p>
                  We share necessary information between buyers, sellers, and
                  riders to facilitate transactions, including names, contact
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <p className="mt-4">
                ...
                settings. However, disabling cookies may limit some features of
                our platform.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <p className="mt-4">
                ...
                anonymize it. Account information is typically retained for 7
                years after account closure as per Bangladesh legal
                requirements.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                ...
                child without parental consent, we will take steps to delete
                that information promptly.
              </p>
              <p>
                Parents or guardians who believe their child has provided us
                with personal information should contact us immediately.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                ...
                and applications. We are not responsible for the privacy
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <span className="text-primary">10.</span> International Data
              Transfers
            </h2>
            <div className="space-y-4 text-gray-700">
              <p>
                Your information may be transferred to and processed in
                countries other than Bangladesh. We ensure that such transfers
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <span className="text-primary">11.</span> Changes to This Privacy
              Policy
            </h2>
            <div className="space-y-4 text-gray-700">
              <p>
                ...
                other factors. We will notify you of significant changes by:
              </p>
              <ul className="list-disc pl-6 space-y-2">
