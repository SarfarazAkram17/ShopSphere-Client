  ...
  const cookieCategories = [
    {
      ...
      examples: [
        ...
        {
          name: "csrf_token",
          purpose: "Security and form validation",
          duration: "Session",
        },
        {
          name: "cart_id",
          purpose: "Stores your shopping cart items",
          duration: "7 days",
        },
        {
          name: "user_preferences",
          purpose: "Remembers your language and currency settings",
          duration: "1 year",
        },
      ],
    },
    {
      ...
      examples: [
        {
          name: "location_data",
          purpose: "Remembers your delivery location",
          duration: "30 days",
        },
        {
          name: "wishlist",
          purpose: "Stores your wishlist items",
          duration: "90 days",
        },
        {
          name: "recently_viewed",
          purpose: "Tracks recently viewed products",
          duration: "30 days",
        },
        {
          name: "ui_preferences",
          purpose: "Remembers display settings and preferences",
          duration: "1 year",
        },
      ],
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          purpose: "Tracks page views and interactions",
          duration: "30 minutes",
        },
        {
          name: "heatmap_data",
          purpose: "Records click patterns for site improvement",
          duration: "1 year",
        },
      ],
    },
    {
      ...
      examples: [
        ...
        {
          name: "user_segment",
          purpose: "Categorizes users for targeted content",
          duration: "6 months",
        },
        {
          name: "ad_preferences",
      ...
      <div className="bg-gradient-to-r from-primary/10 to-primary/5 border-b">
        <div className="max-w-[1500px] px-4 py-8 mx-auto">
          ...
          <p className="text-gray-600 max-w-3xl mt-2">
            This Cookie Policy explains how ShopSphere uses cookies and similar
            tracking technologies on our platform.
          </p>
        </div>
      </div>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <p>
                Cookies help us understand how you use our platform, remember
                your preferences, and improve your overall experience. They
                enable essential features like keeping you logged in and
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6 text-gray-700">
              <p className="mb-6">
                We use different types of cookies to provide, secure, and
                improve our services. Below is a detailed explanation of each
                category:
              </p>
                            ...
                            <table className="w-full border-collapse">
                              <thead>
                                <tr className="bg-base-200">
                                  <th className="text-left p-3 font-semibold text-sm text-gray-900 border">
                                    Cookie Name
                                  </th>
                                  <th className="text-left p-3 font-semibold text-sm text-gray-900 border">
                                    Purpose
                              ...
                              <tbody>
                                {category.examples.map((cookie, index) => (
                                  ...
                                  >
                                    <td className="p-3 text-sm border font-mono text-primary">
                                      {cookie.name}
                                    </td>
                                    <td className="p-3 text-sm border text-gray-700">
                                      {cookie.purpose}
                                    </td>
                                    <td className="p-3 text-sm border text-gray-700">
                                      {cookie.duration}
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <span className="text-primary">3.</span> First-Party vs.
              Third-Party Cookies
            </h2>
            <div className="space-y-6 text-gray-700">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-base-200 p-6 rounded-lg">
                  ...
                  <p className="mb-3">
                    These cookies are set directly by ShopSphere and can only be
                    read by our website.
                  </p>
                ...
                <div className="bg-base-200 p-6 rounded-lg">
                  ...
                  <p className="mb-3">
                    These cookies are set by external services we use to enhance
                    our platform.
                  </p>
                  <ul className="list-disc pl-6 space-y-2 text-sm">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <span className="text-primary">4.</span> Session vs. Persistent
              Cookies
            </h2>
            <div className="space-y-6 text-gray-700">
              <div>
                ...
                <p className="mb-3">
                  ...
                  your browser. They are essential for:
                </p>
              ...
              <div>
                ...
                <p className="mb-3">
                  ...
                  until you delete them. They help us:
                </p>
                <ul className="list-disc pl-6 space-y-2">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-base-100 border rounded-lg p-4">
                  ...
                  <p className="text-sm">
                    Verify your identity, maintain secure sessions, and protect
                ...
                <div className="bg-base-100 border rounded-lg p-4">
                  ...
                  <p className="text-sm">
                    Remember items in your cart and wishlist, store delivery
                    preferences, and enable quick checkout.
                  </p>
                </div>
                ...
                <div className="bg-base-100 border rounded-lg p-4">
                  ...
                  <p className="text-sm">
                    Enable core features, remember your preferences, and provide
                ...
                <div className="bg-base-100 border rounded-lg p-4">
                  ...
                  <p className="text-sm">
                    Analyze how our platform is used, identify popular products,
                ...
                <div className="bg-base-100 border rounded-lg p-4">
                  ...
                  <p className="text-sm">
                    Provide product recommendations, customized content, and
                    relevant offers based on your interests.
                  </p>
                </div>
                ...
                <div className="bg-base-100 border rounded-lg p-4">
                  ...
                  <p className="text-sm">
                    Deliver targeted advertisements, measure ad effectiveness,
                    and show you relevant promotions across the web.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-primary pl-4">
                  ...
                  <p className="text-sm mb-2">
                    Helps us understand how visitors use our platform and
                ...
                <div className="border-l-4 border-primary pl-4">
                  ...
                  <p className="text-sm mb-2">
                    Enables us to measure advertising effectiveness and deliver
                ...
                <div className="border-l-4 border-primary pl-4">
                  ...
                  <p className="text-sm mb-2">
                    Allows us to show targeted advertisements and track
                    conversion from ads.
                  </p>
                  <a
                ...
                <div className="border-l-4 border-primary pl-4">
                  ...
                  <p className="text-sm mb-2">
                    Services like bKash, Nagad, and SSL Commerz use cookies to
                    process secure payments.
                  </p>
                  <p className="text-sm text-gray-600">
                    Please refer to individual payment processor privacy
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <span className="text-primary">7.</span> Managing Your Cookie
              Preferences
            </h2>
            <div className="space-y-6 text-gray-700">
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Accept cookies only from sites you're currently visiting
                  </li>
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
                ...
                <p className="text-sm text-gray-700">
                  If you choose to block or delete cookies, some features of
                  ShopSphere may not function properly. You may be unable to add
                  items to your cart, complete purchases, or access your
                  account. Essential cookies cannot be disabled as they are
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                ...
                websites you visit that you do not want your online activities
                tracked. Currently, there is no universal standard for how DNT
                signals should be interpreted.
              </p>
              <p>
                ShopSphere does not currently respond to DNT signals. However,
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                When you use our mobile app or access our platform through a
                mobile browser, we may use similar technologies to cookies to
                collect information and enhance your experience.
              </p>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong>App Permissions:</strong> Manage location,
                  notification, and data access permissions in your device
                  settings
                </li>
              </ul>
            </div>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <span className="text-primary">10.</span> Changes to This Cookie
              Policy
            </h2>
            <div className="space-y-4 text-gray-700">
              <p>
              ...
              <p>
                When we make significant changes, we will notify you by posting
                a prominent notice on our platform or sending you an email
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <div className="bg-base-200 p-6 rounded-lg mt-4">
                <p className="font-semibold text-gray-900 mb-3">
                  ShopSphere Cookie & Privacy Team
                </p>
          ...
          <section className="mb-12 bg-primary/5 border-l-4 border-primary p-6 rounded">
            ...
            <p className="text-gray-700 mb-4">
              For more information about how we protect your privacy and handle
              your data, please review:
            </p>
            <div className="flex flex-wrap gap-4">
              <Link
                to="/privacy-policy"
                className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-lg border hover:border-primary hover:text-primary transition-colors font-medium"
              >
                Privacy Policy →
              </Link>
              <Link
